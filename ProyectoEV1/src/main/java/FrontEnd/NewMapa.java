 ...
 */
public class NewMapa extends javax.swing.JFrame {
    private final int filas = 6;
    private final int columnas = 6;
    JPanel[][] casillas;
    /**
     * Creates new form NewMapa
     */
    public NewMapa() {
        initComponents();
        dibujarMapa();
    ...
    public void dibujarMapa(){
        ...
        for (int i=0;i<filas; i++){
            for (int j=0;j<columnas;j++){
                ...
                //inician las condicionales
                int pisoRandom = (int) Math.floor(Math.random()*10+1);
                //Muro
                 if (pisoRandom == 2){
                     casillas[i][j].setBackground(Color.black);
                }
                //Agua
                else if (pisoRandom == 3){
                ...
                dibujarPersonaje();
               casillas[i][j].setBounds(x,y,100,50);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Vehiculos en reserva: ");

        jLabel4.setText("Vehiculos enemigos restantes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewMapa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
